...
This project is based on the [Contributor Covenant](https://www.contributor-covenant.org),
version 2.1. It is adapted for a project whose whole purpose is to keep vulnerable
people safe.
...
personal appearance, race, religion, or sexual identity and orientation. We pledge to
act and interact in ways that contribute to an open, welcoming, diverse, inclusive,
...
## A safety rule specific to this project

ledger exists because exposure can be dangerous. In this community, **outing anyone,
or pressuring, tricking, or coercing anyone into disclosing an identity, location, or
affiliation they have not chosen to make public, is among the most serious possible
violations** — whether the target is a community member, a contributor, or a person
named in an archived record, and whether it happens in our spaces or through misuse of
the software. Reports of this kind receive the highest priority.
...
Community leaders will follow these impact guidelines in determining the consequences
...
at https://www.contributor-covenant.org/version/2/1/code_of_conduct.html. Community
Impact Guidelines were inspired by Mozilla's code of conduct enforcement ladder. The
project-specific safety rule above is original to ledger.
