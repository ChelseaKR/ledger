...
Also shipped since (2026-07-02): **RM5** PREMIS Rights entity + locally-minted ARK persistent identifiers + PID in the citation block (`models.PremisRights`, `metadata/pid.py`, PREMIS `rights` in the sidecar/XML, DC `identifier` at ingest, `_citation_html`).
