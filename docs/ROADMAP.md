...
|---|---|---|---|
| Test suite | 1114 passed | `make test` | 2026-08-15 |
| Branch coverage | 88.5% (floor: 88%, `fail_under` in `pyproject.toml`); scoped access/consent/dual-control floor 95% held exactly | `make cov` | 2026-08-15 |
...
| `make verify` portable gate | Green: lint, strict types, 1114 tests, i18n, structural accessibility, dependency/secret scans, truthfulness, suppression hygiene, zizmor | `make verify` | 2026-08-15 |
