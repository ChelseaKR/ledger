...
|---|---|---|---|
| Test suite | 1309 passed | `make test` | 2026-08-27 |
...
| `make verify` portable gate | Green: lint, strict types, 1309 tests, i18n, structural accessibility, dependency/secret scans, truthfulness, suppression hygiene, zizmor | `make verify` | 2026-08-27 |
