...
|---|---|---|---|
| Test suite | 1286 passed | `make test` | 2026-08-29 |
| Branch coverage | 89.2% (floor: 88%, `fail_under` in `pyproject.toml`); scoped access/consent/dual-control floor 95% held exactly; `moderate.py` 90% against its own separate floor | `make cov` | 2026-08-29 |
...
| `make verify` portable gate | Green: lint, strict types, 1286 tests, i18n, structural accessibility, dependency/secret scans, truthfulness, suppression hygiene, zizmor | `make verify` | 2026-08-29 |
