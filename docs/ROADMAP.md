...
|---|---|---|---|
| Test suite | 1383 passed | `make test` | 2026-09-01 |
...
| `make verify` portable gate | Green: lint, strict types, 1383 tests, i18n, structural accessibility, ACR check, dependency/secret scans, Semgrep SAST (when the binary is present), truthfulness, suppression hygiene, zizmor | `make verify` | 2026-09-01 |
