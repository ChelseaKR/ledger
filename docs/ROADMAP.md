...
|---|---|---|---|
| Test suite | 1314 passed | `make test` | 2026-08-27 |
...
| `make verify` portable gate | Green: lint, strict types, 1314 tests, i18n, structural accessibility, dependency/secret scans, Semgrep SAST, truthfulness, suppression hygiene, zizmor | `make verify` | 2026-08-27 |
