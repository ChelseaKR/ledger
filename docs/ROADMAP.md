...
| Security & Supply Chain | SEC-35, SEC-36, SEC-37 | ~~No OpenSSF Scorecard workflow~~ Closed: `.github/workflows/scorecard.yml` runs OSSF Scorecard weekly and on every push to `main`, uploading SARIF to GitHub code scanning and publishing to the public Scorecard API | Closed | `.github/workflows/scorecard.yml` |
