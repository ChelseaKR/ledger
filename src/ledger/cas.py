...
from ledger.fixity import hash_bytes, hash_file
from ledger.models import ContentAddress, FixityResult, HashAlgo
...
class ContentStore:
    ...
    def _store(self, digest: str) -> ContentAddress:
        """Build the :class:`~ledger.models.ContentAddress` for a stored digest."""
    ...
    def get_path(self, addr: ContentAddress) -> Path:
        ...
        Raises :class:`~ledger.errors.ObjectNotFound` (naming only the address,
    ...
    def read_bytes(self, addr: ContentAddress) -> bytes:
        ...
        Raises :class:`~ledger.errors.ObjectNotFound` if it is absent.
        """
    ...
    def open(self, addr: ContentAddress) -> BinaryIO:
        ...
        :class:`~ledger.errors.ObjectNotFound` if the object is absent.
        """
