...
def _messages(translation: gettext.NullTranslations) -> dict[str, str]:
    ...
    return {
        ...
        "sw_warning_label": _("Content warning"),
        "sw_reason_label": _("Reason (required)"),
        "sw_warn_button": _("Add content warning"),
        "sw_takedown_button": _("Take down"),
        "sw_history_link": _("Version history"),
        "mod_invalid_heading": _("Action not recorded"),
        "mod_invalid_body": _(
            "A moderation decision needs a non-empty reason. Go back and supply a rationale, then try again."
        ),
        "hist_heading": _("Version history"),
        "hist_intro": _("Comparing the current record with an earlier saved version. Record {id}."),
        "hist_versions_heading": _("Saved versions"),
        "hist_version_item": _("{when} — superseded by {event}"),
        "hist_none": _("No earlier versions."),
        "hist_previous": _("Previous version"),
        "hist_current": _("Current"),
        "hist_field": _("Field"),
        "hist_field_title": _("Title"),
        "hist_field_description": _("Description"),
        "hist_field_warnings": _("Content warnings"),
        "hist_field_policy": _("Default access"),
        "hist_changed": _("changed"),
        "hist_selected": _("selected"),
        "hist_compare_caption": _(
            "Field-by-field comparison of the current record and the selected earlier version"
        ),
        "hist_back": _("Back to the record"),
