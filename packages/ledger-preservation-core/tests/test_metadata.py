"""Tests for :mod:`ledger_preservation_core.metadata` — PREMIS event log and Dublin Core.
...
from ledger_preservation_core.models import DublinCore, PremisEvent, PremisEventType
