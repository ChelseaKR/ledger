...
The rest of this library proves that bytes are *unchanged* (fixity), but
bit-fixity alone does not keep a record *usable*: a file in an obsolete or
proprietary format can verify
